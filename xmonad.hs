...
defaults = defaultConfig {
        ...
        , normalBorderColor  = "#424652"
        , focusedBorderColor  = "#6B5360"        
...
xmobarTitleColor = "#90ACAD"

-- Color of current workspace in xmobar.
xmobarCurrentWorkspaceColor = "#6D94BD"

myLayoutHook = spacing 6 $ gaps [(U,27)] $ toggleLayouts (noBorders Full) $
